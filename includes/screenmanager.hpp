...
public:
  ScreenManager(EngineContext *context) : _engineContext(context) {};

  /*
   * @brief Pushes a screen to the top of the stack, used when you can go back
  ...
  void render();
  /*
   * @brief Handles, updates and renders
   */
  void run();
};
